...
$(function(){
	...
	*/
	$(".main-slider__image").each(function(index){
		var active = '';
		if (index <= 0) {
	...
	$(".main-slider__arrow_right, .main-slider__arrow_left, .main-slider__nav__item").click(function(){
		...
		var imageBlock = $(".main-slider__image:visible");
			
		if ($(this).is(".main-slider__arrow_right")) {
			var imageBlockNext = imageBlock.next(".main-slider__image");
			if (!imageBlockNext.length) {
				imageBlockNext = $(".main-slider__image").first();
			}
		} else if ($(this).is(".main-slider__arrow_left")) {
			var imageBlockNext = imageBlock.prev(".main-slider__image");
			if (!imageBlockNext.length) {
				imageBlockNext = $(".main-slider__image").last();
			}
		} else {
			var indexNext = $(this).index(),
				imageBlockNext = $(".main-slider__image").eq(indexNext);
		}
